...
},{"process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/@walletconnect/browser-utils/dist/esm/browser.js":[function(require,module,exports) {
"use strict";
...
const getFromWindow = exports.getFromWindow = windowGetters.getFromWindow;
const getFromWindowOrThrow = exports.getFromWindowOrThrow = windowGetters.getFromWindowOrThrow;
const getDocumentOrThrow = exports.getDocumentOrThrow = windowGetters.getDocumentOrThrow;
const getDocument = exports.getDocument = windowGetters.getDocument;
const getNavigatorOrThrow = exports.getNavigatorOrThrow = windowGetters.getNavigatorOrThrow;
const getNavigator = exports.getNavigator = windowGetters.getNavigator;
const getLocationOrThrow = exports.getLocationOrThrow = windowGetters.getLocationOrThrow;
const getLocation = exports.getLocation = windowGetters.getLocation;
const getCryptoOrThrow = exports.getCryptoOrThrow = windowGetters.getCryptoOrThrow;
const getCrypto = exports.getCrypto = windowGetters.getCrypto;
const getLocalStorageOrThrow = exports.getLocalStorageOrThrow = windowGetters.getLocalStorageOrThrow;
const getLocalStorage = exports.getLocalStorage = windowGetters.getLocalStorage;
...
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
const safeJsonParse = exports.safeJsonParse = safeJson.safeJsonParse;
const safeJsonStringify = exports.safeJsonStringify = safeJson.safeJsonStringify;
...
const mobileLinkChoiceKey = exports.mobileLinkChoiceKey = "WALLETCONNECT_DEEPLINK_CHOICE";
...
const reservedEvents = exports.reservedEvents = ["session_request", "session_update", "exchange_key", "connect", "disconnect", "display_uri", "modal_closed", "transport_open", "transport_close", "transport_error"];
const signingMethods = exports.signingMethods = ["eth_sendTransaction", "eth_signTransaction", "eth_sign", "eth_signTypedData", "eth_signTypedData_v1", "eth_signTypedData_v2", "eth_signTypedData_v3", "eth_signTypedData_v4", "personal_sign", "wallet_addEthereumChain", "wallet_switchEthereumChain", "wallet_getPermissions", "wallet_requestPermissions", "wallet_registerOnboarding", "wallet_watchAsset", "wallet_scanQRCode"];
const stateMethods = exports.stateMethods = ["eth_accounts", "eth_chainId", "net_version"];
const infuraNetworks = exports.infuraNetworks = {
  1: "mainnet",
  3: "ropsten",
  4: "rinkeby",
  5: "goerli",
...
},{"buffer":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/_empty.js"}],"node_modules/is-typedarray/index.js":[function(require,module,exports) {
...
},{"is-typedarray":"node_modules/is-typedarray/index.js","buffer":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/@walletconnect/encoding/dist/esm/index.js":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
"use strict";
...
},{"is-typedarray":"node_modules/is-typedarray/index.js","typedarray-to-buffer":"node_modules/typedarray-to-buffer/index.js","buffer":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/@walletconnect/utils/dist/esm/encoding.js":[function(require,module,exports) {
"use strict";
...
},{"process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/@walletconnect/jsonrpc-utils/dist/esm/constants.js":[function(require,module,exports) {
"use strict";
...
const PARSE_ERROR = exports.PARSE_ERROR = "PARSE_ERROR";
const INVALID_REQUEST = exports.INVALID_REQUEST = "INVALID_REQUEST";
const METHOD_NOT_FOUND = exports.METHOD_NOT_FOUND = "METHOD_NOT_FOUND";
const INVALID_PARAMS = exports.INVALID_PARAMS = "INVALID_PARAMS";
const INTERNAL_ERROR = exports.INTERNAL_ERROR = "INTERNAL_ERROR";
const SERVER_ERROR = exports.SERVER_ERROR = "SERVER_ERROR";
const RESERVED_ERROR_CODES = exports.RESERVED_ERROR_CODES = [-32700, -32600, -32601, -32602, -32603];
const SERVER_ERROR_CODE_RANGE = exports.SERVER_ERROR_CODE_RANGE = [-32000, -32099];
const STANDARD_ERROR_MAP = exports.STANDARD_ERROR_MAP = {
  [PARSE_ERROR]: {
    code: -32700,
    message: "Parse error"
  },
...
const DEFAULT_ERROR = exports.DEFAULT_ERROR = SERVER_ERROR;
...
},{"process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/@walletconnect/environment/dist/cjs/index.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const isNodeJs = exports.isNodeJs = _environment.isNode;
...
},{}],"node_modules/@walletconnect/jsonrpc-types/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
exports.IJsonRpcConnection = o;
class n extends e {
  constructor() {
    super();
  }
}
exports.IBaseJsonRpcProvider = n;
class r extends n {
  constructor(c) {
    super();
  }
}
exports.IJsonRpcProvider = r;
},{}],"node_modules/@walletconnect/jsonrpc-utils/dist/esm/types.js":[function(require,module,exports) {
"use strict";
...
},{"@walletconnect/jsonrpc-types":"node_modules/@walletconnect/jsonrpc-types/dist/index.es.js"}],"node_modules/@walletconnect/jsonrpc-utils/dist/esm/url.js":[function(require,module,exports) {
"use strict";
...
const payloadId = exports.payloadId = jsonRpcUtils.payloadId;
function uuid() {
  const result = ((a, b) => {
...
const ERROR_SESSION_CONNECTED = exports.ERROR_SESSION_CONNECTED = "Session currently connected";
const ERROR_SESSION_DISCONNECTED = exports.ERROR_SESSION_DISCONNECTED = "Session currently disconnected";
const ERROR_SESSION_REJECTED = exports.ERROR_SESSION_REJECTED = "Session Rejected";
const ERROR_MISSING_JSON_RPC = exports.ERROR_MISSING_JSON_RPC = "Missing JSON RPC response";
const ERROR_MISSING_RESULT = exports.ERROR_MISSING_RESULT = `JSON-RPC success response must include "result" field`;
const ERROR_MISSING_ERROR = exports.ERROR_MISSING_ERROR = `JSON-RPC error response must include "error" field`;
const ERROR_MISSING_METHOD = exports.ERROR_MISSING_METHOD = `JSON RPC request must have valid "method" value`;
const ERROR_MISSING_ID = exports.ERROR_MISSING_ID = `JSON RPC request must have valid "id" value`;
const ERROR_MISSING_REQUIRED = exports.ERROR_MISSING_REQUIRED = "Missing one of the required parameters: bridge / uri / session";
const ERROR_INVALID_RESPONSE = exports.ERROR_INVALID_RESPONSE = "JSON RPC response format is invalid";
const ERROR_INVALID_URI = exports.ERROR_INVALID_URI = "URI format is invalid";
const ERROR_QRCODE_MODAL_NOT_PROVIDED = exports.ERROR_QRCODE_MODAL_NOT_PROVIDED = "QRCode Modal not provided";
const ERROR_QRCODE_MODAL_USER_CLOSED = exports.ERROR_QRCODE_MODAL_USER_CLOSED = "User close QRCode Modal";
...
const LENGTH_0 = exports.LENGTH_0 = 0;
const LENGTH_1 = exports.LENGTH_1 = 1;
const LENGTH_16 = exports.LENGTH_16 = 16;
const LENGTH_32 = exports.LENGTH_32 = 32;
const LENGTH_64 = exports.LENGTH_64 = 64;
const LENGTH_128 = exports.LENGTH_128 = 128;
const LENGTH_256 = exports.LENGTH_256 = 256;
const LENGTH_512 = exports.LENGTH_512 = 512;
const LENGTH_1024 = exports.LENGTH_1024 = 1024;
...
const AES_LENGTH = exports.AES_LENGTH = _length.LENGTH_256;
const HMAC_LENGTH = exports.HMAC_LENGTH = _length.LENGTH_256;
const AES_BROWSER_ALGO = exports.AES_BROWSER_ALGO = "AES-CBC";
const HMAC_BROWSER_ALGO = exports.HMAC_BROWSER_ALGO = `SHA-${AES_LENGTH}`;
const HMAC_BROWSER = exports.HMAC_BROWSER = "HMAC";
const SHA256_BROWSER_ALGO = exports.SHA256_BROWSER_ALGO = "SHA-256";
const SHA512_BROWSER_ALGO = exports.SHA512_BROWSER_ALGO = "SHA-512";
const AES_NODE_ALGO = exports.AES_NODE_ALGO = `aes-${AES_LENGTH}-cbc`;
const HMAC_NODE_ALGO = exports.HMAC_NODE_ALGO = `sha${HMAC_LENGTH}`;
const SHA256_NODE_ALGO = exports.SHA256_NODE_ALGO = "sha256";
const SHA512_NODE_ALGO = exports.SHA512_NODE_ALGO = "sha512";
const RIPEMD160_NODE_ALGO = exports.RIPEMD160_NODE_ALGO = "ripemd160";
const PREFIX_LENGTH = exports.PREFIX_LENGTH = _length.LENGTH_1;
const KEY_LENGTH = exports.KEY_LENGTH = _length.LENGTH_32;
const IV_LENGTH = exports.IV_LENGTH = _length.LENGTH_16;
const MAC_LENGTH = exports.MAC_LENGTH = _length.LENGTH_32;
...
const HEX_ENC = exports.HEX_ENC = "hex";
const UTF8_ENC = exports.UTF8_ENC = "utf8";
...
const ERROR_BAD_MAC = exports.ERROR_BAD_MAC = "Bad MAC";
...
const ENCRYPT_OP = exports.ENCRYPT_OP = "encrypt";
const DECRYPT_OP = exports.DECRYPT_OP = "decrypt";
const SIGN_OP = exports.SIGN_OP = "sign";
const VERIFY_OP = exports.VERIFY_OP = "verify";
...
var WALLET_CONNECT_EXTENSION_ADAPTERS = [{
  name: "Rainbow",
  chains: [_base.CHAIN_NAMESPACES.EIP155],
...
var WalletConnectV1Adapter = exports.WalletConnectV1Adapter = /*#__PURE__*/function (_BaseEvmAdapter) {
  (0, _inherits2.default)(WalletConnectV1Adapter, _BaseEvmAdapter);
  var _super = _createSuper(WalletConnectV1Adapter);
  function WalletConnectV1Adapter(options) {
    var _this;
    (0, _classCallCheck2.default)(this, WalletConnectV1Adapter);
    _this = _super.call(this, options);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "name", _base.WALLET_ADAPTERS.WALLET_CONNECT_V1);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "adapterOptions", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "status", _base.ADAPTER_STATUS.NOT_READY);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "adapterData", {
      uri: "",
      extensionAdapters: WALLET_CONNECT_EXTENSION_ADAPTERS
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "connector", null);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "wcProvider", null);
  ...
  (0, _createClass2.default)(WalletConnectV1Adapter, [{
    key: "connected",
    get: function get() {
      var _this$connector;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                (0, _get2.default)((0, _getPrototypeOf2.default)(WalletConnectV1Adapter.prototype), "checkInitializationRequirements", this).call(this);
                if (!this.chainConfig) {
                ...
                _base.log.debug("initializing wallet connect v1 adapter");
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                (0, _get2.default)((0, _getPrototypeOf2.default)(WalletConnectV1Adapter.prototype), "checkConnectionRequirements", this).call(this);
                if (this.connector) {
                  _context4.next = 3;
                  break;
                }
                throw _base.WalletInitializationError.notReady("Wallet adapter is not ready yet");
              case 3:
                if (!this.connected) {
                  _context4.next = 7;
                  break;
              ...
              case 13:
                return _context4.abrupt("return", new Promise(function (resolve, reject) {
                  if (!_this2.connector) return reject(_base.WalletInitializationError.notReady("Wallet adapter is not ready yet")); // for wallet connect default modal.

                  _this2.connector.on("modal_closed", /*#__PURE__*/(0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee2() {
                    return _regenerator.default.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _this2.status = _base.ADAPTER_STATUS.READY;
                            _this2.emit(_base.ADAPTER_EVENTS.READY, _base.WALLET_ADAPTERS.WALLET_CONNECT_V1);
                  ...
                  try {
                    ...
                    _this2.connector.on("connect", /*#__PURE__*/function () {
                      var _ref2 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee3(error, payload) {
                        return _regenerator.default.wrap(function _callee3$(_context3) {
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              case 0:
                                if (error) {
                                  _this2.emit(_base.ADAPTER_EVENTS.ERRORED, error);
                                }
                                _base.log.debug("connected event emitted by web3auth");
                                _context3.next = 4;
    ...
    key: "disconnect",
    value: function () {
      var _disconnect = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee6() {
        var options,
          cleanup,
          _args6 = arguments;
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                _context6.next = 6;
                return (0, _get2.default)((0, _getPrototypeOf2.default)(WalletConnectV1Adapter.prototype), "disconnect", this).call(this);
              case 6:
                _context6.next = 8;
    ...
    key: "addChain",
    value: function () {
      var _addChain = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee7(chainConfig) {
    ...
    key: "switchChain",
    value: function () {
      var _switchChain = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee8(connectedChainConfig, chainConfig) {
    ...
    value: function () {
      var _createNewSession = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee10() {
            ...
            switch (_context10.prev = _context10.next) {
              ...
              case 10:
                return _context10.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  if (!_this3.connector) return reject(_base.WalletInitializationError.notReady("Wallet adapter is not ready yet"));
                  _base.log.debug("creating new session for web3auth wallet connect");
                  _this3.connector.on("display_uri", /*#__PURE__*/function () {
                    var _ref3 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee9(err, payload) {
                        ...
                        while (1) {
                          switch (_context9.prev = _context9.next) {
                            case 0:
                              ...
                              _this3.emit(_base.ADAPTER_EVENTS.ERRORED, _base.WalletLoginError.connectionError("Failed to display wallet connect qr code"));
                  ...
                  _this3.connector.createSession({
                    ...
                    _this3.emit(_base.ADAPTER_EVENTS.ERRORED, error);
                    return reject(error);
                  });
                }));
              case 11:
    ...
    value: function () {
      var _onConnectHandler = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee11(params) {
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 2:
                ...
                throw _base.WalletInitializationError.invalidParams("Chain config is not set");
              case 4:
                chainId = params.chainId;
                _base.log.debug("connected chainId in hex");
                if (!(chainId !== parseInt(this.chainConfig.chainId, 16))) {
                  _context11.next = 27;
                  break;
                }
                connectedChainConfig = (0, _base.getChainConfig)(_base.CHAIN_NAMESPACES.EIP155, chainId) || {
              ...
              case 18:
                ...
                _base.log.error("error while chain switching", _context11.t0); // we need to create a new session since old session is already used and
    ...
    value: function subscribeEvents(connector) {
      ...
      connector.on("session_update", /*#__PURE__*/function () {
        var _ref4 = (0, _asyncToGenerator2.default)(/*#__PURE__*/_regenerator.default.mark(function _callee12(error) {
          return _regenerator.default.wrap(function _callee12$(_context12) {
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  if (error) {
                    _this4.emit(_base.ADAPTER_EVENTS.ERRORED, error);
                  }
                case 1:
                case "end":
